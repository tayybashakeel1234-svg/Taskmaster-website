...
export default function Analytics() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex pt-15 min-h-screen bg-gray-100">
        <DashboardSidebar />
        {/* <main className="flex-1 p-6 overflow-auto"> */}
        <main className="flex-1 ml-16  p-20 ">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Pie Chart */}
              <div className="bg-white h-100 p-6 rounded-2xl shadow-md flex flex-col items-center justify-center">
